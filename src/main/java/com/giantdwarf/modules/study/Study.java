...
public class Study {
    ...
    public boolean canUpdateRecruiting() {
        return this.published && this.recruitingUpdatedDateTime == null || this.recruitingUpdatedDateTime.isBefore(LocalDateTime.now().minusMinutes(1));
    }
    ...
    public boolean isRemovable() {
        return !this.published; //공개된 모임은 삭제할 수 없다.
    }
