...
@AnalyzeClasses(packagesOf = StudyStudyolleApplication.class)
public class PackageDependencyTests {
    ...
    @ArchTest
    ArchRule modulesPackageRule = classes().that().resideInAPackage("com.giantdwarf.modules..")
            .should().onlyBeAccessed().byClassesThat()
            .resideInAnyPackage("com.giantdwarf.modules..");
    ...
    @ArchTest
    ArchRule cycleCheck = slices().matching("com.giantdwarf.modules.(*)..")
